	    ...
	    <table>
	        <tr>
	            ...
	            <td class="input-group">
	            	<input type="hidden" id="custId" name="custId" value="${myInfo.custId}">
	            	${myInfo.custId}
	            </td>
	        </tr>
	        <tr>
	            <th>이름</th>
	            <td class="input-group">
	            	<input type="hidden" id="custName" name="custName" value="${myInfo.custName}">
	            	${myInfo.custName}
	            </td>
	        </tr>
	        <tr>
	        ...
	        <tr>
	        	<th>우편번호</th>	
	        	<td><input type="text" id="custZipcode" name="custZipcode" value="${myInfo.custZipcode}" size="5" readonly>
        		 <input  type="button" id="searchZipBtn" name="searchZipBtn" value="우편번호 찾기"><br></td>          		          		 
	        </tr>
	        <tr>
	        	<th>주소</th>
	        	<td><input type="text" id="custAddress" name="custAddress" value="${myInfo.custAddress}" readonly></td>	        	
	        </tr>
	        <tr>
	        	<th>상세주소</th>
	        	<td><input type="text" id="custDetailAddress" name="custDetailAddress" value="${myInfo.custDetailAddress}" placeholder="상세주소를 입력해주세요" ></td>
	        </tr>
	       	<tr>
	            <th>카카오 로그인</th>
	            <td class="toggle">
	            <div class="input-switch">
					 ...
					 <label for="inputSwitch" data-on="OFF" data-off="ON"></label>				 
				</div>
				<div>
	        ...
	        <tr>	        
	            <th>비밀번호</th>
	            <td><button type="button" class="change" onclick="changePassword()">변경하기</button></td>
